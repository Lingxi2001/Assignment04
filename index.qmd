...
data %>% 
  ...
  labs(x = "Year", y = "Electricity as Percent Share of Primary Energy \n(percentage point)", 
     title = "Total Electricity Generation \n as Percentage Share of Total Primary Energy Consumption \n for BRICS Countries from 2010 to 2018")
```
Finding: almost all the countries' electricity's share in energy has increased....
Total electricity generation as share of primary energy - Measured as a percentage of total, direct primary energy consumption.
